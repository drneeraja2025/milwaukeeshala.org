...
export const mr: Dict = {
  ...
  "footer.copy": "© {year} मिलवॉकी मराठी शाळा · महाराष्ट्र मंडळ मिलवॉकीचा कार्यक्रम",
  ...
  "pay.lead":
    "वार्षिक फी किंवा देणगी Zelle द्वारे मिलवॉकी मराठी शाळेला पाठवा.",
  ...
  "staff.lead":
    "मिलवॉकी मराठी शाळेचे शिक्षक, स्वयंसेवक आणि संपर्क व्यक्ती.",
